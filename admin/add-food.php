        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                if(isset($_POST['featured'])){
                    ...
                    $featured = "No"; //default değer gelir.
                }
                ...
                if(isset($_FILES['image']['name'])){    
                    ...
                    if($image_name != ""){
                     ...
                     $image_name = ""; //default değer gelir.
                }

                $sql2= "INSERT INTO tbl_foo SET
                    title='$title',
                ...
                if($res2==true){
                    $_SESSION['add']= "<div class='success'> Yemek başarıyla eklendi.</div>";
