<?php include ('partials-front/menu.php') ?>
    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>food-search.php" method="POST">
                <input type="search" name="search" placeholder="Aramak istediğiniz yemek..." required>
        ...
        <div class="container">
            ...
            <?php 
                ...
                if($count>0){
                                ...
                                <div class="box-3 float-container">
                                    <?php 
                                        if($image_name==""){
                                            ...
                                            echo  "<div class='error'>Fotoğrafa erişim yoktur.</div>";
                    ...
                    echo "<div class= 'error'>Kategori eklenemedi.</div>";
                }
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php   
                $sql2= "SELECT * FROM tbl_foo WHERE active='Yes' AND featured='Yes'";
...
/*
                ...
                if($count2>0){
                    while($row= mysqli_fetch_assoc($res2)){
                        ...
                        <div class="food-menu-box">
                            <div class="food-menu-img">
                                <?php
                                    if($image_name==""){
                                        echo "<div class='error'>Fotoğrafa erişilemez.</div>";
                                    }
                                    else{
                    ...
                    echo "<div class='error'>Yemek aktif değildir.</div>";
                }
